...
![lops subdiv attribute](/wiki/houdini/lops_subdiv_wrangle.png)
...
Source:
[houdini/lop_import_lights.py](/wiki/houdini/lop_import_lights.py)
...
Source:
[usd/match_size.py](/wiki/usd/match_size.py)
