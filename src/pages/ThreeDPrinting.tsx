...
const prints: PrintEntry[] = [
  {
    name: 'Prototype wall LCD screen',
    description: 'A prototype housing for a round wall-mounted LCD screen.',
    status: 'Printed',
  ...
  {
    name: 'Mug shelf',
    description: 'A shelf for holding mugs, with tall sides and a curved cutout at the front.',
    status: 'Printed',
    statusClassName: 'bg-emerald-50 text-emerald-700 ring-emerald-200',
    date: '22 August 2026',
    dateTime: '2026-08-22',
  ...
  },
  {
    ...
    description: 'A small weighted block that keeps desk cables from sliding out of reach.',
    status: 'Printed',
    statusClassName: 'bg-emerald-50 text-emerald-700 ring-emerald-200',
    date: '21 August 2026',
    dateTime: '2026-08-21',
  ...
  {
    name: 'AA and AAA battery crates',
    description: 'A pair of ribbed crates for sorting AA and AAA batteries, printed together on tree supports.',
    status: 'Printed',
    statusClassName: 'bg-emerald-50 text-emerald-700 ring-emerald-200',
    date: '19 August 2026',
    dateTime: '2026-08-19',
  ...
  {
    name: 'Lattice pen holder',
    description: 'A pen holder with a solid base that rises into an open diamond lattice.',
    status: 'Printed',
    statusClassName: 'bg-emerald-50 text-emerald-700 ring-emerald-200',
    date: '19 August 2026',
    dateTime: '2026-08-19',
  ...
  {
    name: 'Hat hanger',
    description: 'A flat wall bracket with a rounded peg for hanging a hat.',
    status: 'Printed',
    statusClassName: 'bg-emerald-50 text-emerald-700 ring-emerald-200',
    date: '27 July 2026',
    dateTime: '2026-07-27',
  ...
  {
    name: 'Door clothes hangers',
    description: 'A row of stepped hooks that sits over the top of a door to hang clothes from.',
    status: 'Printed',
    statusClassName: 'bg-emerald-50 text-emerald-700 ring-emerald-200',
    date: '27 July 2026',
    dateTime: '2026-07-27',
